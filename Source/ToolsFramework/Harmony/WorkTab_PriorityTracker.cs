    ...
    public static class Patch_PriorityTracker_InvalidateCache
    {
        ...
        public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
        {
            ...
            instructionList.InsertRange(0, new List<CodeInstruction>
            {
                ...
                new CodeInstruction(OpCodes.Call, AccessTools.Method(typeof(RimworldExtensions), nameof(RimworldExtensions.CanUseTools), new Type[]{ typeof(Pawn), typeof(Pawn_ToolTracker).MakeByRefType()})),
                new CodeInstruction(OpCodes.Brfalse, labelFinish),
